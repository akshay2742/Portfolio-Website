            ...
            class r extends s.b {
                static initClass() {
                    this.prototype.defaultOptions = {
                        ...
                        color: 8978176
                    }, this.prototype.colors = [16720469, 16716185, 16737996, 8978176, 7851025, 16776960, 16742195, 1179647, 1149149, 16768290, 2250188, 7975100, 5468283]
                }
                constructor(t) {
                    n = t.THREE || n, super(t)
                }
                material(t) {
                    return new n.MeshLambertMaterial({
                        color: t
                    })
                }
                genRing(t, e, i, s, r, h, a) {
                    null == s && (s = 0), null == r && (r = 1.4 * Math.PI), null == h && (h = 0), null == a && (a = 1), this.rings || (this.rings = []), e < 1 && (e = 1);
                    const c = {
                            amount: .4,
                            bevelEnabled: !1,
                            steps: 1,
                        ...
                        u = new n.Shape;
                    u.absarc(0, 0, e + i, 0, r, !1), u.lineTo(e * Math.cos(r), e * Math.sin(r)), u.absarc(0, 0, e, r, 0, !0);
                    const l = new n.ExtrudeGeometry(u, c),
                        d = this.material(t);
                    (0 === Object(o.g)(0, 1) || e > 60) && (d.transparent = !0, d.opacity = Math.max(50 / e + Object(o.h)(-.3, .3), .1));
                    const p = new n.Mesh(l, d);
                    if (p.rotation.x = Math.PI / 2, p.rotation.z = s, p.position.y = h, p.speed = .001 * a, p.receiveShadow = !0, p.castShadow = !0, this.rings.push(p), this.cont.add(p), e < 20 && r < 1.3 * Math.PI && Object(o.g)(0, 2)) try {
                        this.genRing(Object(o.i)(this.colors), e + Object(o.h)(-1, 3), i + Object(o.h)(-2, 0), s + r, r + Object(o.h)(-.5, .5), h + Object(o.h)(-3, 1), a)
                    } catch (t) {}
                    return p
                }
                onInit() {
                    ...
                    this.cont = new n.Group, this.cont.position.set(30, 0, 0), this.cont.rotation.x = .06667, this.cont.rotation.z = .16667, this.scene.add(this.cont);
                    let i = Object(o.e)() ? 30 : 60;
                    for (let e = 0; e < i; e++) {
                        let e;
                        Object(o.g)(0, 3) ? (e = Object(o.h)(2, 4) + Object(o.h)(1, 30) * Object(o.h)(1, 2) * Object(o.h)(1, 2) * Object(o.h)(1, 2), Object(o.e)() && (e *= .5), t = Object(o.h)(0, 3.5) + Object(o.h)(0, 3.5) - Object(o.g)(0, e / 4) - e / 50) : (e = Object(o.h)(1, 3) * Object(o.h)(2, 4), t = Object(o.h)(1, 2) * Object(o.h)(1, 2) * Object(o.h)(1.1, 1.5));
                        const i = .05 * Math.pow(2, Object(o.g)(0, 4));
                        t < i && (t = i), this.genRing(Object(o.i)(this.colors), e, t, Object(o.h)(0, 1e3), Object(o.h)(1, 6), Object(o.h)(0, 50 / (e + 1) + 5) + 5 / t / (e + .5), .25 * Math.max(-Object(o.h)(.5, 2), Object(o.h)(1, 50 - e / 2) - e / 2))
                    }
                    this.camera = new n.PerspectiveCamera(25, this.width / this.height, 10, 1e4), this.camera.position.set(0, 150, 200), this.scene.add(this.camera);
                    const s = new n.AmbientLight(16777215, .5);
                    return this.scene.add(s), this.pointLight = new n.PointLight(16777215, .5), this.pointLight.position.set(0, 150, 200), this.scene.add(this.pointLight), this.spot = new n.SpotLight(16777215, 1), this.spot.position.set(-15, 50, 100), this.spot.penumbra = 1, this.spot.angle = .5, this.spot.decay = 1, this.spot.distance = 300, this.spot.target = this.cont, this.scene.add(this.spot)
                }
                onUpdate() {
                    let t;
                    null != this.helper && this.helper.update(), null != this.controls && this.controls.update();
                    const e = this.camera;
                    Math.abs(e.tx - e.position.x) > .01 && (t = e.tx - e.position.x, e.position.x += .02 * t), Math.abs(e.ty - e.position.y) > .01 && (t = e.ty - e.position.y, e.position.y += .02 * t), e.lookAt(new n.Vector3(0, 25, 7)), e.near = Math.max(.5 * e.position.z - 20, 1), e.updateProjectionMatrix();
                    for (let t of Array.from(null != this.rings ? this.rings : [])) t.rotation.z += t.speed;
                    const i = .001 * this.t;
                    return this.cont.rotation.x += 1e-4 * Math.sin(i), this.cont.rotation.z += 7e-5 * Math.cos(i)
                }
                onMouseMove(t, e) {
                    const i = this.camera;
                    return i.oy || (i.oy = i.position.y, i.ox = i.position.x), i.tx = i.ox + 50 * (t - .5), i.ty = i.oy - 50 * e
                }
            }
