    ...
    return function (t) {
        ...
        8: function (t, e, i) {
            ...
            class r extends s.b {
                ...
                onInit() {
                    var t = this.camera = new n.PerspectiveCamera(50, this.width / this.height, .1, 5e3);
                    t.position.x = 0, t.position.y = 250, t.position.z = 50, t.tx = 0, t.ty = 50, t.tz = 350, t.lookAt(0, 0, 0), this.scene.add(t);
                    var e, i, s, r, h, a, c, u = this.starsGeometry = new n.Geometry,
                        l = this.options.spacing;
                    for (e = s = -30; s <= 30; e = ++s)
                        for (i = r = -30; r <= 30; i = ++r)(h = new n.Vector3).x = e * l + l / 2, h.y = Object(o.h)(0, 5) - 150, h.z = i * l + l / 2, u.vertices.push(h);
                    if (a = new n.PointsMaterial({
                            color: this.options.color,
                            size: this.options.size
                        }), c = this.starField = new n.Points(u, a), this.scene.add(c), this.options.showLines) {
                        var d = new n.LineBasicMaterial({
                                color: this.options.color2
                            }),
                            p = new n.Geometry;
                        for (e = 0; e < 200; e++) {
                            var f = Object(o.h)(40, 60),
                                m = f + Object(o.h)(12, 20),
                                w = Object(o.h)(-1, 1),
                                g = Math.sqrt(1 - w * w),
                                v = Object(o.h)(0, 2 * Math.PI),
                                y = Math.sin(v) * g,
                                M = Math.cos(v) * g;
                            p.vertices.push(new n.Vector3(M * f, y * f, w * f)), p.vertices.push(new n.Vector3(M * m, y * m, w * m))
                        }
                        this.linesMesh = new n.LineSegments(p, d), this.scene.add(this.linesMesh)
                    }
                }
                onUpdate() {
                    ...
                    const s = this.camera;
                    s.position.x += .003 * (s.tx - s.position.x), s.position.y += .003 * (s.ty - s.position.y), s.position.z += .003 * (s.tz - s.position.z), s.lookAt(0, 0, 0), this.linesMesh && (this.linesMesh.rotation.z += .002, this.linesMesh.rotation.x += 8e-4, this.linesMesh.rotation.y += 5e-4)
                }
                onMouseMove(t, e) {
            ...
            r.initClass(), e.default = s.a.register("DOTS", r)
        }
    })
});